...
H("7 · la tercera corrida viva (autorizada, 2 llamadas): la reparación cumplió los cinco puntos y cayó por tres falsos positivos — cerrados");
{
  ...
  /* …y el mismo error una vez más, que entonces tampoco se vio (owner 2026-09-14, atribución y significado): «el precio de lista de estos clientes está más
   * pegado al costo (markup promedio 41.4% …)» — «estos clientes» remite a la lista que precede («Falabella 4.5%, Líder 4.2%, Sodimac 5.4%»: el lector ya
   * lee una lista cuyos nombres traen su cifra pegada) y el 41.4% es de las OCHO bajo el benchmark, el mismo reparto que la auditoría cobró en
...
H("14 · universo de grupos · ordinales y rankings · «coincide en dos dominios» no es razón: los tres, sobre las respuestas reales");
{
  ...
  /* v2.31 (owner 2026-09-14, grupos, conteos, universos e inventos): la DESCRIPCIÓN de un grupo también se verifica contra la boleta — «las cuentas
   * con carga sobre el nivel declarado» es, en la boleta, el grupo de 6 del subtotal de carga (Falabella, Sodimac, Lider, Easy, Jumbo, Ripley),
   * no el de «erosión por acciones comerciales» (con Paris, sin Easy) que pesa 73.8 %. La descripción propia del grupo pasa; la de otro grupo arde. */
  ok(!arde("Falabella, Lider, Jumbo, Sodimac, Paris y Ripley (73.8% de la venta) tienen margen bajo el benchmark.", "cifra-de-grupo-mal-repartida") && !arde("Seis cuentas con margen bajo el benchmark y carga sobre el nivel pesan 73.8% de la venta.", "cifra-de-grupo-mal-repartida") && kinds("Las cuentas que erosionan por acciones comerciales pesan 73.8% de la venta.").length === 0, "el grupo completo, «seis cuentas» y la descripción propia sin lista pasan (y el 73.8% ya está autorizado por la boleta)", kinds("Las cuentas que erosionan por acciones comerciales pesan 73.8% de la venta.").join(","));
  ok(arde("Las cuentas con carga sobre el nivel declarado pesan 73.8% de la venta.", "cifra-de-grupo-mal-repartida"), "candado v2.31: la descripción de OTRO grupo de la boleta (las 6 sobre el nivel declarado, con Easy y sin Paris) con la cifra de la erosión arde");
