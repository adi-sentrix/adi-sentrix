...
const bod = buildComparisonReading("bodega", "Valparaíso", "Santiago", "bonanza");   // capital · menos = mejor
const CASES = [
  ...
  { name: "bodega · comparación en capital · gap en $ (gapFmt $12.0K) · menos capital = mejor (Santiago)", pass: !!bod && bod.kind === "comparison" && bod.a.entity === "Valparaíso" && bod.gapFmt === "$12.0K" && bod.better === "Santiago" && /menos capital inmovilizado/.test(bod.reframe) },
  { name: "bodega · driver = cobertura (DOH) lado a lado", pass: !!bod && /cobertura \d+d/.test(bod.a.sub) && /cobertura \d+d/.test(bod.b.sub) && /cobertura/.test(bod.drivers[2].label) },
];
