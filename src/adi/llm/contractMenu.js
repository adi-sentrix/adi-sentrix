...
const OPERATIONS = [
  ...
  ["diagnose", "dónde se está perdiendo/inmovilizando plata en la cartera, GENERAL · ej: '¿dónde pierdo dinero?', '¿qué me come el margen?' · barre los focos (contribución no capturada · carga comercial alta · capital dormido) y los ordena por impacto en $. OJO: si la pregunta es ESPECÍFICA de capital/inventario/bodega/SKU → usá `inventory`, no `diagnose`."],
