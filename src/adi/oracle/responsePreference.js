...
export function buildPrefDoctrine() {
  ...
  - contentScope="data_only": "solo el dato/la cifra/el número", "sin análisis/interpretación", "solo cifras/KPIs" → quiere el dato sin la lectura. Reconocé también cualquier paráfrasis equivalente, por ejemplo: "solo dame el dato", "dime únicamente las ventas", "sin explicación", "nada más", "directo al número/resultado", "cuánto fue y punto", "no me des contexto", "solo el resultado", "solo la tabla", "muéstrame la lista y nada más" — la lista de arriba es orientativa, no taxativa: cualquier forma coloquial que pida el dato pelado sin lectura cuenta.
  ...
  - contentScope="results_only": en una simulación, "solo los resultados", "sin recomendación", "no me recomiendes" → quiere el efecto del supuesto, no el consejo. "No me recomiendes"/"sin análisis" fuera de una simulación (mode≠"simulacion") es data_only, no results_only — el eje resultados-sin-recomendación solo existe cuando hay un supuesto simulado del que separar el consejo.
