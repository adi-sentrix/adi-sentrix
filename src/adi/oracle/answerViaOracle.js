...
export async function answerViaOracle({ text, history = [], mem = {}, scenario = "actual", callPlan, callNarrate, maxCalls = 6, requestContext = null, uiSignals = null, viewContext = null } = {}) {
  ...
  const _VERDICTOS_DE_REDACCION = /cifra-no-autorizada|cifra-de-dato-sin-dueno|cifra-de-boleta-sin-dueno|metrica-mal-atribuida|procedencia-no-autorizada|causa-sobredimensionada|estado-no-declarado|ranking-no-sostenido|vocabulario-no-contractual|ambiguedad-no-declarada|alcance-heredado-cambiado|alcance-heredado-incompleto|escenario-inviable|calculo-no-verificable/;
