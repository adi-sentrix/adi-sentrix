...
import { _respaldoDeLoYaAprobado } from "./respaldoAprobado.js";   // paso 0 de la Poda: el peldaño compartido, fuera del módulo que se retira
 ...
 */
/* EL PELDAÑO DEL RESPALDO vive en respaldoAprobado.js desde el paso 0 de la Poda (owner 2026-09-03):
 * lo comparten esta escalera y la del AGENTE, y el agente no puede depender de un módulo con fecha de
 * retiro. Acá solo se IMPORTA — el call-site de la escalera del suplente queda idéntico. */
