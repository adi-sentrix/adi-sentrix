...
entityRecord{dimension,entity} — LA FILA COMPLETA de UNA entidad: TODAS sus columnas reales. Usalo para preguntas de CAMPO CONCRETO. dimension: cliente/sku/marca/familia. Ej: "cuántas unidades tengo del SKU X" → {dimension:"sku",entity:"X"}; "el rebate del cliente X" → {dimension:"cliente",entity:"X"}; "todo del SKU Y" → {dimension:"sku",entity:"Y"}. Trae: unidades en stock, valor de inventario, rotación, cobertura(DOH), días sin venta, estado, ventas, margen, contribución, rebate, precio de lista, etc. El nombre de la entidad SIEMPRE es el que use EL USUARIO — nunca inventes uno.
