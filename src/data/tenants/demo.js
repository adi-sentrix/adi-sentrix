/* === data/tenants/demo.js · EL TENANT DEMO (F1 multiempresa · 2026-07-26) ===
 * El dataset del demo COMPLETO en un solo lugar: los mismos literales byte-idénticos que vivían en
 * demoData.js / skusMargen.js / baseKpis.js / catalogs.js / config/scenarios.js (extraídos de 41cc33d8).
...
export const MARCAS_ALL    = ["Samsung","LG","Philips","Bosch","Makita"];
