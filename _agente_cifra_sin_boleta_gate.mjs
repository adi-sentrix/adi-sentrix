...
await carnada("el juez desconectado del bucle", "src/adi/agente/bucleAgente.js",
  [[/    const vSinBoleta = \(sitio === "cierre" \|\| sitio === "reparacion" \|\| sitio === "declaracion"(?: \|\| sitio === "reanclaje")?\) \? vetoCifraSinBoleta\(\{/,   // «reanclaje» se sumó a los sitios del cerebro con el Notario v3 (E3)
