...
const CASES = [
  ...
  { name: "CTRL-DOH-AVISA", q: "el peor SKU por DOH", mk: "inventario",
    check: (r) => /habilitado en esta fase|inventario/.test(r.text) && r.route !== "spine_inv_superlative" },
  { name: "CTRL-cobertura-AVISA", q: "qué SKU tiene peor cobertura", mk: "inventario",
